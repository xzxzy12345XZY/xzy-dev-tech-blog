...
Sitemap: ${l}${h}${d}
`;await f.writeFile(a,g,{flag:"w"}),m.succeed()}},_=(e,t=!0)=>o=>{t&&A(e),G(o,L,"2.0.0-beta.67"),o.env.isDebug&&m.info("Options:",e);const s={name:L};return e.hostname?{...s,onGenerated:l=>I(l,e)}:(m.error(`Option ${w.magenta("hostname")} is required!`),s)};export{_ as sitemapPlugin};
